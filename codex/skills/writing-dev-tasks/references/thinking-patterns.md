...
Apply structured thinking patterns at each phase for better outcomes. The patterns referenced below (`atomic-thought`, `tree-of-thoughts`, and the rest) come from the `thinking-patterns` skill. Phase names below match the phases in `../SKILL.md`.
