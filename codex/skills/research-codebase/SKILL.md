...
6. Persist only when needed.
   ...
   - When persisting, use [templates/research-document.md](templates/research-document.md) as the starting structure and adapt only the sections supported by the evidence.
...
- [templates/research-document.md](templates/research-document.md) - Persisted research document structure for artifact-driven workflows
