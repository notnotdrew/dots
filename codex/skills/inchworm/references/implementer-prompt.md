...
- If the selected find is a leftover write, duplicate call, or equivalent-path tidy inside a block comments already mark undocumented, temporary, or "maybe remove," report `too_large`. A nibble does not make the real deletion easier.
