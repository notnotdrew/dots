...
| `source` | string | One of: `lint`, `errors`, `backlog`, `smell`, `slow` |
...
| `evidence` | string | Optional link a reviewer can open: Honeybadger fault, Linear issue, CI run, Datadog APM resource/trace, file path |
