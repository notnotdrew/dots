...
| Path | Notes |
| --- | --- |
| `CLAUDE.md` | Primary Claude instruction file in the repo root |
| `.claude/CLAUDE.md` | Alternative Claude instruction location |
| `.claude/settings.json` | May contain Claude-specific instruction overrides |
